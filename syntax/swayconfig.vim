...
syn match i3ConfigLidMode /lid:\(on\|off\)\s/ contained
"syn keyword i3ConfigBindKeyword bindsym bindswitch bindcode exec gaps border contained
...
"syn match i3ConfigBind /^\s*\(bindsym\|bindswitch\|bindcode\)\s\+.*$/ contains=i3ConfigVariable,i3ConfigBindKeyword,i3ConfigVariableAndModifier,i3ConfigNumber,i3ConfigUnit,i3ConfigUnitOr,i3ConfigBindArgument,i3ConfigModifier,i3ConfigAction,i3ConfigString,i3ConfigGapStyleKeyword,i3ConfigBorderStyleKeyword,i3ConfigLidMode 
syn match i3ConfigBind /^\s*\(bindsym\|bindcode\)\s\+.*$/ contains=i3ConfigVariable,i3ConfigBindKeyword,i3ConfigVariableAndModifier,i3ConfigNumber,i3ConfigUnit,i3ConfigUnitOr,i3ConfigBindArgument,i3ConfigModifier,i3ConfigAction,i3ConfigString,i3ConfigGapStyleKeyword,i3ConfigBorderStyleKeyword,i3ConfigLidMode 


" Bindswitch
syn keyword swayConfigBindswitchKeyword bindswitch contained
syn match swayConfigBindswitchArgument /--\(locked\|no-warn\|reload\)\s/ contained
syn match swayConfigLidMode /lid:\(on\|off\)\s/ contained
syn match swayConfigBindswitch /^\s*bindswitch\s\+.*$/ contains=swayConfigBindswitchKeyword,swayConfigBindswitchArgument,swayConfigLidMode

hi def link swayConfigLidMode                               Type
hi def link swayConfigBindswitchKeyword                     Identifier
hi def link swayConfigBindswitchArgument                    PreProc
